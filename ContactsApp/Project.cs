...
public class Project
{
    ...
    /// </summary>
    public ObservableCollection<Contact> Contacts { set; get; } = new ();
    ...
    public IEnumerable<Contact> SortContacts()
    {
        ...
        return Contacts.OrderBy(contact => contact.LastName);
    }
    ...
    public ObservableCollection<Contact> SearchContacts(string substring)
    {
        ...
        var response = SortContacts()
            .Where(
                contact => contact.FirstName.Contains(substring)
    ...
    {
        var response = Contacts.Where(
                contact =>
                    contact.Birthday.Day == date.Date.Day && contact.Birthday.Month == date.Month)
            .ToArray();
