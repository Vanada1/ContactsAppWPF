                                                     ...
                                                     ?? (_addContactCommand =
                                                         new RelayCommand<object>(
                                                             o =>
                                                             {
                                                                 ...
                                                                 var listBoxControl =
                                                                     GetContactsListControlViewModel(
                                                                         o);
                                                                 listBoxControl.AllContacts.Add(
                                                                     viewModel
                                                          ...
                                                          new RelayCommand<object>(
                                                              o =>
                                                              {
                                                                  var listBoxControl =
                                                                      GetContactsListControlViewModel(
                                                                          o);
                                                                  if (listBoxControl.SelectedContact
                                                                      == null)
                                                                  {
