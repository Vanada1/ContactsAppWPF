...
public class ProjectTests
{
    ...
    public void TestSort_CorrectValue()
    {
        ...
        Assert.AreEqual(
            expected.Contacts[0].LastName,
            actual.Contacts[0].LastName,
            "Dotes not sorted");
    }
    ...
    public void TestFindBirthday_HasContacts()
    {
        ...
        var actual = project.FindBirthdayContacts(new DateTime(1900, 12, 31));

        Assert.AreEqual(
            expected[0].LastName,
            actual[0].LastName,
            "Fail to find people's birthday");
    }
    ...
    public void TestFindIndex_HasNotContacts()
    {
        ...
        var actual = project.FindIndex(
            new Contact(
                "U",
                "U",
                new PhoneNumber("77800000000"),
                new DateTime(2001, 12, 31),
                "U",
                "U"));
